...
Logic Apps would provide workflow centered integration capabilities if the platform needs them. It is optional as Function Apps, Data Factory, and application code would likely cover most integration patterns.
...
- Introduce Logic Apps only when connector driven or workflow use cases justify another integration runtime.
- Decide how it fits relative to Function Apps and Data Factory to avoid overlapping patterns.
- Align network and identity design with the private networking requirements.
...
- Are there workflow or connector scenarios that cannot be addressed cleanly with existing/better suited services?
- Should Logic Apps be reserved for external integrations rather than internal platform flows?
- What hosting and networking model would satisfy private environment requirements?
...
- Introduce these when workflow speed and connector breadth outweigh the cost of another integration platform.
