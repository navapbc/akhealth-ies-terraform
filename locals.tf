...
//Much of the mapping in here (as far as methods calling for substring) is just to ensure final formulated names adhere to naming restrictions on the resource
